...
android {
    namespace = "com.bluetechloop.mvvmtempleteproject"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.bluetechloop.mvvmtempleteproject"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
//    implementation("androidx.lifecycle:lifecycle-extensions:2.6.0-alpha03")
